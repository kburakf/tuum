...
(
    ...
    CONSTRAINT balances_account_fk FOREIGN KEY (account_id) REFERENCES accounts (id) ON DELETE SET NULL
    );
...
(
    ...
    CONSTRAINT transactions_account_fk FOREIGN KEY (account_id) REFERENCES accounts (id) ON DELETE SET NULL
    );